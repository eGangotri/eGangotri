...
class GetFirstAndLastNPagesFromPdf {
    ...
    static PDF_EXTRACTOR_STATS = [
        ...
        "PDF_PAGE_EXTRACT_FOLDER_TOTAL_PDF_COUNT": 0,
            ...
            "PDF_PAGE_EXTRACT_FOLDER_NAME": "",
            "PDF_PAGE_EXTRACT_SUCCESS": false
    ...
    static String execute(String[] args) {
        ...
        PDF_EXTRACTOR_STATS.PDF_PAGE_EXTRACT_SUCCESS = PDF_EXTRACTOR_STATS.PDF_PAGE_EXTRACT_COUNTER == PDF_EXTRACTOR_STATS.PDF_PAGE_EXTRACT_FOLDER_TOTAL_PDF_COUNT
        PDF_EXTRACTOR_REPORT = "Extract Pages Report for ${PDF_EXTRACTOR_STATS.PDF_PAGE_EXTRACT_FOLDER_NAME}:\n" +
                "Folder # (${PDF_EXTRACTOR_STATS.PDF_PAGE_EXTRACT_FOLDER_INDEX}/${PDF_EXTRACTOR_STATS.PDF_PAGE_EXTRACT_TOTAL_FOLDER_COUNT}).\n" +
                "PDF Count ${PDF_EXTRACTOR_STATS.PDF_PAGE_EXTRACT_COUNTER} == PDF_COUNTER ${PDF_EXTRACTOR_STATS.PDF_PAGE_EXTRACT_FOLDER_TOTAL_PDF_COUNT} Match" +
                " ${PDF_EXTRACTOR_STATS.PDF_PAGE_EXTRACT_SUCCESS}"
